...
import { selectCarousel, setEnlargedImages } from '../../store/slices/carouselSlice';
...
const EnlargedCarouselImage = () => {
  ...
  return (
    <div className={style.enlarged_carousel_image_overlay} onClick={handleClose}>
    <div className={style.enlarged_carousel_image_container}>
      ...
      <div className={style.image_info}>
        <h2>{enlargedImage.title} {enlargedImage.price}$</h2>
